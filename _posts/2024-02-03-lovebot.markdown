...
<figure class="kg-card kg-image-card"><img src="{{ site.baseurl }}content/images/2024/02/image-2.png" class="kg-image" alt="" loading="lazy" width="1080" height="212" srcset="{{ site.baseurl }}content/images/size/w600/2024/02/image-2.png 600w,{{ site.baseurl }}content/images/size/w1000/2024/02/image-2.png 1000w,{{ site.baseurl }}content/images/2024/02/image-2.png 1080w" sizes="(min-width: 720px) 720px"></figure>
## **Revenues**
<figure class="kg-card kg-image-card"><img src="{{ site.baseurl }}content/images/2024/02/image.png" class="kg-image" alt="" loading="lazy" width="1764" height="632" srcset="{{ site.baseurl }}content/images/size/w600/2024/02/image.png 600w,{{ site.baseurl }}content/images/size/w1000/2024/02/image.png 1000w,{{ site.baseurl }}content/images/size/w1600/2024/02/image.png 1600w,{{ site.baseurl }}content/images/2024/02/image.png 1764w" sizes="(min-width: 720px) 720px"></figure>
...
<figure class="kg-card kg-image-card"><img src="{{ site.baseurl }}content/images/2024/02/image-1.png" class="kg-image" alt="" loading="lazy" width="1080" height="312" srcset="{{ site.baseurl }}content/images/size/w600/2024/02/image-1.png 600w,{{ site.baseurl }}content/images/size/w1000/2024/02/image-1.png 1000w,{{ site.baseurl }}content/images/2024/02/image-1.png 1080w" sizes="(min-width: 720px) 720px"></figure>
...
### Model selection
<figure class="kg-card kg-image-card"><img src="{{ site.baseurl }}content/images/2024/02/image-3.png" class="kg-image" alt="" loading="lazy" width="1768" height="968" srcset="{{ site.baseurl }}content/images/size/w600/2024/02/image-3.png 600w,{{ site.baseurl }}content/images/size/w1000/2024/02/image-3.png 1000w,{{ site.baseurl }}content/images/size/w1600/2024/02/image-3.png 1600w,{{ site.baseurl }}content/images/2024/02/image-3.png 1768w" sizes="(min-width: 720px) 720px"></figure>
...
## Profit calculation
<figure class="kg-card kg-image-card"><img src="{{ site.baseurl }}content/images/2024/02/image-4.png" class="kg-image" alt="" loading="lazy" width="1080" height="558" srcset="{{ site.baseurl }}content/images/size/w600/2024/02/image-4.png 600w,{{ site.baseurl }}content/images/size/w1000/2024/02/image-4.png 1000w,{{ site.baseurl }}content/images/2024/02/image-4.png 1080w" sizes="(min-width: 720px) 720px"></figure>
